...
id_var <- "school_id"
y_var <- "Q30C_exhausted_r_2wks"
lv1_vars <- c('c_Time', 'c_Q46_age', 'Q47_gender', 'race_ethn', 'Q52_enrollment', 'Q55_international', 
              'survey_method')
...
res <- logistic_model_wrapper(
    ...
    model_save_name = "exhausted_item_all_cov_linear"
)
